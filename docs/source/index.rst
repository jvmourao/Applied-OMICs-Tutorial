...
During this tutorial, we will use real next-generation sequencing (NGS) data retrieved from the Sequence Read Archive (SRA). In the end, you will able to assemble and analyze bacterial genomes.
...
Almost none. This course is an introduction, so the only thing that you need to know is where to find your Terminal.
